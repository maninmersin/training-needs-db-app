...
import { calculateClassroomsNeeded, validateClassroomCapacity } from '../utils/classroomCalculations';
  ...
  useEffect(() => {
    const fetchSelectionData = async () => {
      try {
        ...
        // Fetch functional areas from reference table first
        ...
        if (areasError) {
          ...
          // Fallback: Fetch distinct functional areas from courses
        ...
        // Fetch training locations from reference table first
        ...
        if (locationsError) {
          ...
          // Fallback: Fetch distinct training locations from end users
