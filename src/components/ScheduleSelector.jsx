          ...
          <div className="schedule-table" key={`table-${cssLoaded ? 'loaded' : 'loading'}`}>
            <div className="table-header">
              <div className="header-row" style={{ 
                display: 'grid',
                gridTemplateColumns: '2fr minmax(140px, 160px) minmax(140px, 160px) minmax(80px, 100px) minmax(80px, 100px) minmax(80px, 100px) minmax(80px, 100px) minmax(100px, 120px) minmax(130px, 150px)',
                alignItems: 'center',
                padding: 0,
                gap: '4px'
              }}>
