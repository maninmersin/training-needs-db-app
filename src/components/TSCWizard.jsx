...
} from '../utils/classroomCalculations';
import { getCurrentLocalDateTime } from '../utils/dateTimeUtils';
...
const TSCWizard = () => {
  ...
  const handleFinish = async (scheduleNameFromReview) => {
    try {
      ...
      const scheduleId = await saveTrainingSchedule(criteria[selectedFunctionalArea] || {}, selectedFunctionalArea, scheduleNameFromReview);
      await saveTrainingSessionsForSchedule(sessionsForCalendar, scheduleId, selectedFunctionalArea, criteria[selectedFunctionalArea] || {});
