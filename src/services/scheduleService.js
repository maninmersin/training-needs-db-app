 ...
 */
export const saveTrainingSchedule = async (currentCriteria, functionalArea, scheduleName = null) => {
  try {
 ...
 */
export const saveScheduleAs = async (originalScheduleId, newScheduleName, newDescription = null) => {
  try {
    console.log(`📋 Creating copy of schedule ${originalScheduleId} as "${newScheduleName}"`);
    
    // Step 1: Load the original schedule
    const originalSchedule = await loadTrainingSchedule(originalScheduleId);
    ...
    // Step 3: Load and copy all sessions from the original schedule
 ...
 */
export const updateTrainingSchedule = async (scheduleId, updates) => {
  try {
    const updateData = {
      ...updates,
 ...
 */
export const saveTrainingSessionsForSchedule = async (sessionsGrouped, scheduleId, functionalArea, currentCriteria) => {
  try {
 ...
 */
export const loadTrainingSchedule = async (scheduleId) => {
  try {
    const { data, error } = await supabase
      .from('training_schedules')
      .select('*')
 ...
 */
export const loadTrainingSessionsForSchedule = async (scheduleId) => {
  try {
 ...
 */
export const bulkUpdateTrainingSessions = async (sessionUpdates) => {
  try {
